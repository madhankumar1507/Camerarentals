package com.camerarentals.config;

import com.camerarentals.security.JwtAuthenticationEntryPoint;
import com.camerarentals.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers(HttpMethod.GET, "/cameras/**").permitAll()
